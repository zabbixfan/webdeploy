...
#  pbex._tqm._stdout_callback = cb
  ...
  return filename
#if __name__ == 'main':
pbexe('10.86.87.1','ansible','/geelyapp/tomcat-ansible','http://10.86.87.253:8088/Beta/VSD/Openapi/openapi.war')
